...
function Media() {
  ...
  const fallbackItems: MediaItem[] = [
    { image: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab', description: { ar: 'مشروع ١', en: 'Project 1' } },
    { image: 'https://images.unsplash.com/photo-1497366216548-37526070297c', description: { ar: 'مشروع ٢', en: 'Project 2' } },
    { image: 'https://images.unsplash.com/photo-1497366754035-f200968a6e72', description: { ar: 'مشروع ٣', en: 'Project 3' } },
  ];
          ...
          {mediaItems.map((item, index) => (
            <div key={index} className="bg-white rounded-lg shadow-md overflow-hidden">
              <img
                ...
                alt={typeof item?.description === 'string' ? item.description : (t(item?.description) || pickText(item?.description) || '')}
              ...
              <div className="p-4">
                <p className="text-gray-800 text-right leading-relaxed">
                  {typeof item?.description === 'string'
                    ? item.description
                    : (t(item?.description) || pickText(item?.description) || '')}
                </p>
              </div>
            </div>
          ))}
