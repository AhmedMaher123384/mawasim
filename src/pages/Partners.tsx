...
function Partners() {
  ...
  const items = itemsRaw.length
    ? itemsRaw
    : [
        { name: { ar: 'شريك ١', en: 'Partner 1' }, logo: '', link: '' },
        { name: { ar: 'شريك ٢', en: 'Partner 2' }, logo: '', link: '' },
        { name: { ar: 'شريك ٣', en: 'Partner 3' }, logo: '', link: '' },
      ];
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {items.map((it, idx) => {
            ...
            const logo = typeof it?.logo === 'string' ? it.logo : '';
